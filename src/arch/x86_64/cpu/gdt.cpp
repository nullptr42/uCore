...
enum Flags { Coarse = (1 << 3), Mode32 = (1 << 2), Mode64 = (1 << 1) };
...
enum AccessByte {
  ...
  AccessRing0 = (AccessByte::Present | AccessByte::Ring0 | AccessByte::Segment |
                 AccessByte::Writeable),
  AccessRing3 = (AccessByte::Present | AccessByte::Ring3 | AccessByte::Segment |
                 AccessByte::Writeable)
};
...
extern "C" void gdt_reload(GdtPointer *pointer, uint8_t codesegment,
                           uint8_t datasegment);

static GdtEntry g_gdt_table[] = {
    {0, 0, 0, 0},
    {0, 0xFFFFF, Flags::Coarse | Flags::Mode64,
     AccessByte::AccessRing0 | AccessByte::Executable},
    {0, 0xFFFFF, Flags::Coarse | Flags::Mode32, AccessByte::AccessRing0},
    {0, 0xFFFFF, Flags::Coarse | Flags::Mode64,
     AccessByte::AccessRing3 | AccessByte::Executable},
    {0, 0xFFFFF, Flags::Coarse | Flags::Mode32, AccessByte::AccessRing3}};

static GdtPointer g_gdt_pointer = {.limit = sizeof(g_gdt_table) - 1,
